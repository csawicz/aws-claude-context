...
> 🚀 **Quick Start**: `claude mcp add claude-context -e AWS_REGION=us-east-1 -e S3_VECTORS_BUCKET_NAME=your-bucket -- npx @zilliz/claude-context-mcp@latest`
...
<details>
<summary>AWS Configuration (Recommended) 👈</summary>
...
> 📋 **Complete Setup Guide**: See [CLAUDE_CODE_SETUP.md](CLAUDE_CODE_SETUP.md) for detailed build and development instructions.
...
- **Embedding Providers**: [AWS Bedrock](https://aws.amazon.com/bedrock/) (default), [OpenAI](https://openai.com), [VoyageAI](https://voyageai.com), [Ollama](https://ollama.ai), [Gemini](https://gemini.google.com)
- **Vector Databases**: [AWS S3Vectors](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/s3vectors/) (default), [Milvus](https://milvus.io), or [Zilliz Cloud](https://zilliz.com/cloud)
...
> 📋 **Complete Setup Guide**: See [CLAUDE_CODE_SETUP.md](CLAUDE_CODE_SETUP.md) for detailed Claude Code integration instructions.
