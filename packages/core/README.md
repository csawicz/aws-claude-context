...
The package defaults to AWS services when AWS credentials are available:

```bash
# AWS credentials (can also use ~/.aws/credentials or IAM roles)
AWS_REGION=us-east-1
AWS_ACCESS_KEY_ID=your-access-key
AWS_SECRET_ACCESS_KEY=your-secret-key

# S3Vectors bucket for vector storage
S3_VECTORS_BUCKET_NAME=my-claude-context-vectors

# Optional: Specify Bedrock embedding model (defaults to amazon.titan-embed-text-v2:0)
...
Get a free Milvus vector database on Zilliz Cloud. You can [sign up](https://cloud.zilliz.com/signup?utm_source=github&utm_medium=referral&utm_campaign=2507-codecontext-readme) on Zilliz Cloud to get a free Serverless cluster.
...
// const context = new Context(); // Uses AWS services if credentials available
```
...
- **AWS Bedrock** (default) - Amazon Titan Text Embeddings V2, Cohere embeddings
...
- **AWS S3Vectors** (default) - Dedicated vector database service with sub-second search
