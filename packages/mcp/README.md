...
- S3Vectors bucket created in your AWS account

**Legacy Setup:**
- API key for your chosen embedding provider (OpenAI, VoyageAI, Gemini, or Ollama)
...
Claude Context MCP supports multiple embedding providers, with AWS Bedrock as the default when AWS credentials are available:
...
```bash
# Supported providers: Bedrock (default), OpenAI, VoyageAI, Gemini, Ollama
EMBEDDING_PROVIDER=Bedrock
```

<details>
<summary><strong>AWS Bedrock Configuration (Recommended)</strong></summary>

AWS Bedrock provides high-quality embeddings with excellent performance and cost-effectiveness.
...
# Vector database: S3Vectors bucket name
